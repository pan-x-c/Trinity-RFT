...
| *Benchmarks* | + [ Benchmark toolkit (quick verification & experimentation)](./benchmark/README.md)<br>+ [Guru-Math benchmark & comparsion with veRL](./benchmark/reports/guru_math.md)<br>+ [FrozenLake benchmark & comparsion with rLLM](./benchmark/reports/frozenlake.md)<br>+ [Alfworld benchmark & comparsion with rLLM](./benchmark/reports/alfworld.md) |
