...
| *基准测试* | + [ 基准测试工具 (快速验证与实验)](./benchmark/README.md)<br>+ [Guru-Math 测试 & 对比 veRL](./benchmark/reports/guru_math.md)<br>+ [FrozenLake 测试 & 对比 rLLM](./benchmark/reports/frozenlake.md)<br>+ [Alfworld 测试 & 对比 rLLM](./benchmark/reports/alfworld.md) |
