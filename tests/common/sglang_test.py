...
class TestRecording(RayUnittestBaseAsync):
    ...
    the right ``record_key``, and that ``POST /records/update_record`` flushes
    the recorder, reward-stamps the whole record-key group, pops it, and returns
    it as serialized experiences.
