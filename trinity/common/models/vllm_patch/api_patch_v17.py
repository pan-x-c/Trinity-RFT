"""Patch for vllm OpenAI API server. Only for vllm versions >= 0.17.0.
"""
import asyncio
import functools
import logging
...
def patch_vllm_reasoning_content_alias(logger: logging.Logger) -> None:
    ...
    _patched_parse_chat_message_content.__patched_reasoning_content_alias__ = True
...
async def run_api_server_in_ray_actor_v17(
    async_llm,
    host: str,
    port: int,
    model_path: str,
