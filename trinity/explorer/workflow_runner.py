...
def calculate_run_level_metrics(experiences: List[Experience]) -> Dict[str, float]:
    ...
    For non-repeatable workflows, this function will aggregate the metrics from experiences
    ...
    Keys without a suffix default to mean.

    For repeatable workflows, please do not use this function.
    """
    from trinity.utils.metrics import aggregate_run_level_metrics

    metric_dicts = [exp.metrics for exp in experiences if exp.metrics]
    return aggregate_run_level_metrics(metric_dicts)
